/* @ts-self-types="./rustrender_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function render_markdown(markdown, options) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(markdown, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.render_markdown(retptr, ptr0, len0, addHeapObject(options));
 ...
 * @returns {string}
 */
export function render_markdown_json(markdown, options_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.render_markdown_json(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rustrender_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
